...
router.get('/', validateQuery(schemas.prescriptionQuery), prescriptionController.getPrescriptions);
...
router.put('/items/:itemId/dispense', prescriptionController.dispensePrescriptionItem);
